...
def load_images_and_labels(known_directories):
    data = []
    labels = []
    class_names = os.listdir(known_directories)
...
datagen = ImageDataGenerator(
    ...
    featurewise_center=True,  # 평균 정규화 적용
    featurewise_std_normalization=True)  # 표준편차 정규화 적용
...
model.add(Dense(len(set(known_labels)), activation='softmax'))
